...
export const SignLanguageConverter: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Sign Language Converter</h1>
        <p className="text-gray-600">Break communication barriers with our sign language tool</p>
      </div>
